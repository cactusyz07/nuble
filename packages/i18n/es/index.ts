...
const es: Translation = {
  main: {
    updater: {
      ...
      message: 'Una nueva version ({version}) de Nuble esta disponible. ¿Quieres descargar la actualización?',
      messageRequired:
        'Está disponible una nueva versión ({version}) obligatoria de Nuble, puedes descárgarla en GitHub.',
  ...
  window: {
    main: {
      tabsOverflow: {
        text: '"Nuble no admite más de 6 pestañas por ventana, al abrir una pestaña adicional puede ocasionar errores y bugs. Pero puede abrir una nueva ventana y funcionará bien".'
      }
    },
    changelog: {
  ...
  option: {
    ...
    multiAccount: {
      ...
      notConfigured:
        'Para utilizar esta función, se debe configurar una contraseña. Se utilizará para iniciar Nuble con las automatizaciones multicuenta.',
    ...
    about: {
      ...
      text0: 'Nuble es un software de última generación que te permite jugar DOFUS Touch directamente desde tu computador.',
      text1:
      ...
      text2:
        'Desarrollado por el equipo de Nuble, esta aplicación presenta un estilo de marca 2026 ultrapremium, rendimiento impecable y cero errores.'
    }
  },
  // MODS Texts
  mod: {
