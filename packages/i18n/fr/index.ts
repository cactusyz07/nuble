...
const fr: Translation = {
  main: {
    updater: {
      ...
      message: 'Une nouvelle version ({version}) de Nuble est disponible. Voulez-vous télécharger la mise à jour?',
      messageRequired:
        'Une nouvelle version ({version}) obligatoire de Nuble est disponible, vous pouvez la télécharger sur GitHub.',
  ...
  window: {
    main: {
      tabsOverflow: {
        text: 'Nuble ne garantit pas le support de plus de 6 onglets par fenêtre, vous pouvez cependant ouvrir une autre fenêtre ou bien continuer au risque de bugs !'
      }
    },
    changelog: {
    ...
    updateGame: {
      ...
      step8: 'Étape 8 : Lancement de Nuble..',
      information: {
  ...
  option: {
    ...
    shortcuts: {
      ...
      application: {
        ...
        newTab: 'Nouvel onglet',
        tab: 'Onglet {x}',
        window: 'Basculer vers la fenêtre {x}',
        nextTab: 'Onglet suivant',
        prevTab: 'Onglet précédent'
      },
      spells: {
    ...
    multiAccount: {
      ...
      notConfigured:
        'Pour utiliser cette fonctionnalité, un mot de passe doit être configuré. Il sera utilisé afin de démarrer Nuble avec les automatismes du multi-compte.',
    ...
    about: {
      ...
      text0: 'Nuble est un logiciel de pointe vous permettant de jouer à DOFUS Touch directement depuis votre ordinateur.',
      text1:
        'Contrairement à un émulateur Android, le code est directement interprété par votre ordinateur, ce qui rend sa lecture incroyablement rapide et vous permet de profiter pleinement des performances de votre ordinateur !',
      text2:
        "Développé par l'équipe Nuble, cette application propose un style de marque 2026 ultra-premium, des performances irréprochables et aucun bug."
    }
  },
  // MODS Texts
  mod: {
