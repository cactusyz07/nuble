...
const en: BaseTranslation = {
  main: {
    updater: {
      ...
      message: 'A new version ({version: string}) of Nuble is available. Do you want to update?',
      messageRequired: 'A required update ({version: string}) of Nuble is available, you must download it on GitHub.',
      download: 'Download',
      ignore: 'Ignore'
    },
    gameMenu: {
  ...
  window: {
    main: {
      tabsOverflow: {
        text: "Nuble doesn't support more than 6 tab per window, above that it can be laggy and buggy. But you can open a new window and it will be working just fine."
      }
    },
    changelog: {
      title: 'Release notes',
    ...
    updateGame: {
      ...
      step2: 'Step 2 : Nuble patch download',
  ...
  option: {
    ...
    shortcuts: {
      ...
      application: {
        ...
        newTab: 'New tab',
        tab: 'Tab {x:number}',
        window: 'Switch to Window {x:number}',
        nextTab: 'Next tab',
        prevTab: 'Previous tab'
      },
      spells: {
    ...
    about: {
      ...
      text0: 'Nuble is a state-of-the-art software that allows you to play DOFUS Touch directly from your computer.',
      text1:
